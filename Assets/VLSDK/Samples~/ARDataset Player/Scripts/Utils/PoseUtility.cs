...
namespace ARCeye.Dataset
{
    public class PoseUtility
    {
        ...
        static public Matrix4x4 FloatArrayToMatrix4x4(float[] arr)
        {
            return new Matrix4x4(
        ...
        static public string MatrixToString(Matrix4x4 matrix)
        {
        ...
        static public Matrix4x4 ConvertOpenGLToUnityMatrix(Matrix4x4 openGLMatrix)
        {
            ...
            // Convert the matrix
            Matrix4x4 unityMatrix = conversionMatrix * openGLMatrix * conversionMatrix;
            return unityMatrix;
        }
    }
}