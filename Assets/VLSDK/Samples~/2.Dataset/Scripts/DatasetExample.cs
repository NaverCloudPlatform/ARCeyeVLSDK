...
namespace ARCeye.Example.Dataset
{
    public class DatasetExample : MonoBehaviour
    {
        [Header("VLSDK")]
        ...
        private void Awake()
        {
            var adaptor = GameObject.FindAnyObjectByType<CustomPoseTrackerAdaptor>();
            if (adaptor == null)
            {
                Debug.LogError("Error! CustomPoseTrackerAdaptor not found in VLSDKManager. Please add CustomPoseTrackerAdaptor to VLSDKManager.");
            }
